...
import proba from '../../_assets/proba.png';
import sendRes from './sendReceive.png';
import taxAuth from './taxAuth.png';
    ...
    hints: [
      {
        ...
        positionY: '200px',
        content: [
          'Use the dashboard to oversee all of the transmitted invoices.',
        ],
      },
      {
        positionX: '200px',
      ...
      },
      {
        ...
        positionY: '200px',
        content: [
          'You or your customers can issue/receive invoices, credit-notes, storno invoices, etc.',
        ],
      },
    ],
  },
    ...
    hints: [
      {
        ...
        content: [
          ...
          { url: '', text: 'Read more about e-invoicing >' },
        ],
      },
    ],
  },
    ...
    hints: [
      {
        ...
        content: [
          ...
          { url: '', text: 'Read more about fiscalization requirements >' },
        ],
      },
    ],
  },
